    ...
    content: `
      <div class="roadmap-timeline">
        ...
        <div class="roadmap-item done">
          ...
          <div class="roadmap-title">Mainnet Migration <span class="badge-done">COMPLETED</span></div>
          <ul class="roadmap-items">
            <li><strong>Mainnet Hardening:</strong> Successful migration of all protocol contracts and storage nodes to the 0G Aristotle Mainnet.</li>
            <li><strong>Semantic Recall:</strong> Full integration of vector embedding similarity search (cosine similarity) for advanced context retrieval.</li>
            ...
            <li><strong>0G Pay Readiness:</strong> Integration of the protocol's fee layer with the 0G Pay unified payments infrastructure for mainnet settlement.</li>
          </ul>
        </div>
        <div class="roadmap-item active">
          <div class="roadmap-phase">Phase 3</div>
          <div class="roadmap-title">Sovereign Intelligence <span class="badge-wip">IN PROGRESS</span></div>
          <ul class="roadmap-items">
            <li><strong>Sealed RAG:</strong> Deployment of TEE-sealed Retrieval Augmented Generation via 0G Compute to prevent memory leakage during the inference cycle. <span class="text-accent-cyan">[LIVE]</span></li>
            <li><strong>0G Pay × Khalani Settlement:</strong> Enabling intent-based payments for cross-chain memory subsidies and Compute Credits. <span class="text-accent-cyan">[ACTIVE]</span></li>
